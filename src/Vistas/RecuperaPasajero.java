 ...
 * @author PC
 */
public class RecuperaPasajero extends javax.swing.JInternalFrame {

    /**
     * Creates new form RecuperaPasajero
     */
    ...
    private void jbBuscarIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbBuscarIdActionPerformed
        ...
        p = pasaData.buscarPasajeroPorIdBorrado(id);
        if (p != null) {
            borrarFilas();
